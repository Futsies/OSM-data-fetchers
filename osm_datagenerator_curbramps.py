...
tags_of_interest = ['surface', 'barrier', 'kerb']  # Add any other tags that you're interested in
...
for way in result.ways:
    ...
    if ('barrier' in properties and properties['barrier'] == 'kerb'):
    #if ('barrier' in properties and properties['barrier'] != 'null'):
...
if ways:
    ...
    gdf.to_file("curbs.geojson", driver='GeoJSON')
else:
